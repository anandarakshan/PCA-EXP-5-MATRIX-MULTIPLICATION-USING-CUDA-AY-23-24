...
```
## OUTPUT:
<img width="1130" height="763" alt="image" src="https://github.com/user-attachments/assets/d73b271e-51a2-4a0a-8e98-19a693eaa098" />


## RESULT:
Thus the program has been executed by using CUDA to mulptiply two matrices. It is observed that there are variations in host and device elapsed time. Device took 3.7440us time and host took 0.000229 seconds time.
